<template>
    <label for="toggle" class="switch-toggle-label"  @click="popStatus">
         <input type="checkbox" name="toggle" id="toggle" :checked="on">
    </label>
...
#toggle:checked + .switch-toggle-label::after {
  left: 50%;
}
#toggle:checked + .switch-toggle-label::before {
  left: 0;
  content: 'ON';
}
#toggle:checked + .switch-toggle-label {
